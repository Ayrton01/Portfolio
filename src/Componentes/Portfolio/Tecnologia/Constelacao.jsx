...
const Constelacao = () => {
  const [hoveredNode, setHoveredNode] = useState(null); // Para efeito de mouse hover
  const [pinnedNode, setPinnedNode] = useState(null);   // Para nós "fixados" com clique/toque
  ...
  return (
    <div className="absolute inset-0 w-full h-full">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none z-10 svg-draw-path">
        {techs.map((tech, i) => {
          // O nó ativo é o que está "pinado" ou, se não houver nenhum, o que está com o mouse em cima.
