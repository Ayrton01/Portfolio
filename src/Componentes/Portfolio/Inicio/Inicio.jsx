...
const Inicio = () => {
  return (
    <>
      ...
      <section id="inicio" className="relative flex flex-col items-center justify-center min-h-screen max-h-[900px] pt-24 pb-12 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 bg-[#161822]/80 backdrop-blur-sm w-[95%] sm:w-[90%] md:w-full max-w-3xl mx-auto px-6 py-6 sm:px-10 sm:py-5 md:px-16 md:py-5 rounded-3xl md:rounded-[40px] border border-white/5 shadow-2xl shadow-indigo-500/10 flex flex-col items-center overflow-hidden">
          ...
          <header className="max-w-3xl flex flex-col items-center relative z-10 w-full text-center">
